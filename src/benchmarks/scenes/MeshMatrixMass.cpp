...
BENCHMARK_TEMPLATE1(BM_Scene_bench, MeshMatrixMassScene)->RangeMultiplier(stepSubIterations)->Ranges({ {minSubIterations, maxSubIterations} })->Unit(benchmark::kMillisecond);